...
from {{cookiecutter.project_name}}.tests.base import TestFunctionalBase
...
class TestFunctionalRegister(TestFunctionalBase):
    ...
    def test_user_can_register(self):
        ...
        username_field = self.get_by_input_name(form, 'name')
        username_field.send_keys('admin')

        email_field = self.get_by_input_name(form, 'username')
        ...
        self.assertEqual(self.live_server_url + reverse('calorie:home'), self.live_server_url + reverse('calorie:home'))
